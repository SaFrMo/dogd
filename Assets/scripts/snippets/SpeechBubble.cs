...
public class SpeechBubble : MonoBehaviour 
{
	...
	void OnGUI()
	{
		...
		GUI.BeginGroup(new Rect(goScreenPos.x-centerOffsetX-offsetX,Screen.height-goScreenPos.y-centerOffsetY-offsetY,bubbleWidth,bubbleHeight));
			...
			//Render the text
		GUI.Label(new Rect(10,25,190,50),"Target ship Grand Duchy within sensor range. Zero life forms aboard ship. Shall I begin playing the boarding message?",guiSkin.label);
